...
<Steps>
  ...
  <Step>
    ...
    Two rules — *Restart loop* and *Container crash (non-zero exit)* — ship preconfigured but disabled. Enable them with one click, or add more [alert rules](/en/docs/homelab/alerts) for resource thresholds or per-stack scoping.
  </Step>
  <Step>
  ...
  <Step>
    ...
    When something breaks, generate a [diagnostic bundle](/en/docs/homelab/diagnostic-bundle) with one click, edit the Compose YAML in the [built-in editor](/en/docs/docker/compose#edit-composeyaml) or the [.env editor](/en/docs/docker/containers#visual-env-editor), and apply the fix.
  </Step>
</Steps>
