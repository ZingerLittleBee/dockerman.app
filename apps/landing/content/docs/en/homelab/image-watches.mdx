...
1. You subscribe to images you care about.
...
3. For each subscribed image, Dockerman compares the local digest with the remote registry digest.
4. When a new digest is found, Dockerman sends a notification through your configured [notification channels](/en/docs/homelab/notifications).
