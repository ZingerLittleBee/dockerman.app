...
description: Poll container image registries in the background and notify when a new digest is available.
---
...
1. You subscribe to images by host and image reference.
...
The dedicated page lists all subscriptions.
