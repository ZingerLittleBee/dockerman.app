...
Follow the official Docker Engine install instructions for your distribution at [docs.docker.com/engine/install/](https://docs.docker.com/engine/install/), then confirm the daemon is running. Dockerman does not document a minimum Docker Engine version.
