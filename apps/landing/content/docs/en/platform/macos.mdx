...
- Remote-host passwords and private-key contents are stored locally by Dockerman. The current desktop implementation does not place these values in macOS Keychain.
