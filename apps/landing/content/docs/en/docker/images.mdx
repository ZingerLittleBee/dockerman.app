---
title: Images
description: Pull, build, push, analyze, and scan Docker images.
---
...
<Steps>
  ...
  <Step>
    ...
    Add or select a registry in the registry manager. The push dialog requests credentials from that saved entry; it does not import `~/.docker/config.json` or accept ad-hoc credentials per push.
  </Step>
  <Step>
