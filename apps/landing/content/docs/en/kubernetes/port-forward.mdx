...
Dockerman can forward a port from a Pod, Service, or Deployment to the local machine. Active forwards can reconnect automatically according to the Kubernetes settings.
