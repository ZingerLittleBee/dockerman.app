...
The active forwards list shows the target, local port, status, and Stop action. Dockerman reconnects after transient network errors.
...
Add a hostname and IP mapping manually when you want a static entry or when automatic DNS is not available. Manual entries stay in place across app restarts.
