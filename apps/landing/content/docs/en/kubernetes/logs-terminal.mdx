...
Open Logs from a Pod and choose one of its regular containers. The viewer uses the same search and follow controls documented for [container logs](/en/docs/docker/logs).
