...
Use EndpointSlices for the discovery objects Kubernetes currently maintains behind Services. Dockerman provides a dedicated list and detail route alongside legacy Endpoints.
