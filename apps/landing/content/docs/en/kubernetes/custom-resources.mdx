...
description: Discover CRDs and inspect or edit custom resource instances.
---

Dockerman discovers CustomResourceDefinitions from the connected cluster and lists their API group, kind, scope, served versions, and age.
