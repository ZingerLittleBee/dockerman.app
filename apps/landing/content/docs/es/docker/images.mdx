...
Envía una imagen etiquetada tras elegir un registro configurado en el gestor de registros de Dockerman.
...
<Steps>
  ...
  <Step>
    ...
    Añade o elige una entrada del gestor. El diálogo obtiene las credenciales de esa entrada; no promete importar `~/.docker/config.json` ni credenciales ad-hoc por envío.
  </Step>
  <Step>
...
<Callout type="warn">
  La instalación y las actualizaciones de base de datos pueden requerir red. El tamaño y la caché dependen de la versión instalada.
</Callout>
