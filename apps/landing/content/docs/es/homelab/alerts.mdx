...
La página de Alertas incluye una pestaña de historial mostrando cada vez que una regla se disparó, con:

- Timestamp
- Nombre de regla y tipo
- Contexto (nombre de contenedor, valor de métrica, código de salida, etc.)
