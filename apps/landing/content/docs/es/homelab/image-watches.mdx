...
1. Te suscribes a las imágenes que te importan.
...
3. Para cada imagen suscrita, Dockerman compara el digest local con el digest del registro remoto.
4. Cuando se encuentra un nuevo digest, Dockerman envía una notificación a través de tus [canales de notificación](/es/docs/homelab/notifications) configurados.
