...
Dockerman puede gestionar el binario de Trivy. Un escaneo aún puede necesitar descargar o actualizar la base de datos, por lo que no se garantiza el uso offline.
