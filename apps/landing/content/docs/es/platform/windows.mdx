...
Añadido en v5.3.0. Si la distro Alpine entra en un estado defectuoso, abre el asistente de configuración de WSL y haz clic en **Reinstall** para anular el registro de `dockerman-backend` e importar una imagen Alpine nueva.
