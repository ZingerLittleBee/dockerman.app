...
LimitRange、ResourceQuota、PodDisruptionBudget にも dedicated page があります。

Namespace page では list、create、delete ができます。namespace deletion は namespaced resource を削除する可能性があり、UI は API の全 cascade warning を再現するとは限りません。
