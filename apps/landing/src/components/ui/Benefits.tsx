...
export default function Benefits() {
  return (
    <section aria-labelledby="benefits-title" className="mx-auto mt-44">
      <h2
        className="inline-block bg-gradient-to-t from-gray-900 to-gray-800 bg-clip-text py-2 font-bold text-4xl text-transparent tracking-tighter md:text-5xl dark:from-gray-50 dark:to-gray-300"
        id="benefits-title"
      >
      ...
      <dl className="mt-8 grid grid-cols-4 gap-x-10 gap-y-8 sm:mt-12 sm:gap-y-10">
        {benefits.map((benefit, index) => (
          <div className="col-span-4 sm:col-span-2 lg:col-span-1" key={index}>
            ...
            <dd className="mt-2 text-gray-600 leading-7 dark:text-gray-400">
              {benefit.description}
            </dd>
          </div>
        ))}
