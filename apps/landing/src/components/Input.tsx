...
import { cx, focusInput, focusRing, hasErrorInput } from '@repo/shared/utils'
...
const inputStyles = tv({
  base: [
    ...
    // file
    [
      'file:-my-2 file:-ml-2.5 file:cursor-pointer file:rounded-r-none file:rounded-l-[5px] file:border-0 file:px-3 file:py-2 file:outline-none focus:outline-none disabled:pointer-events-none file:disabled:pointer-events-none',
      'file:border-gray-300 file:border-solid file:bg-gray-50 file:text-gray-500 file:hover:bg-gray-100 file:dark:border-gray-800 file:dark:bg-gray-950 file:disabled:dark:border-gray-700 file:hover:dark:bg-gray-900/20',
    ...
    return (
      <div className={cx('relative w-full', className)} tremor-id="tremor-raw">
        ...
        {isSearch && (
          ...
          >
            <RiSearchLine aria-hidden="true" className="size-[1.125rem] shrink-0" />
          </div>
        )}
        {isPassword && (
          <div
