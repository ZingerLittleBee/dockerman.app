    ...
    <div className="mt-36 flex flex-col overflow-hidden px-3 pb-16">
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-lg text-gray-700 dark:text-gray-400">
          This agreement outlines how Dockerman processes and protects your
          data.
        </p>
      </section>
        ...
        <div className="space-y-8 rounded-xl bg-white p-8 shadow-lg shadow-gray-200/50 ring-1 ring-gray-200/50 dark:bg-gray-900 dark:shadow-none dark:ring-gray-800">
          ...
          <div className="space-y-6">
            ...
            <p className="ml-11 text-gray-600 dark:text-gray-400">
              We retain account data for as long as your account is active or as
              needed to provide services. You can request data deletion by
              contacting our support team. Local data remains under your control
              and is stored only on your device.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="ml-11 text-gray-600 dark:text-gray-400">
              For any questions about data processing or to exercise your
