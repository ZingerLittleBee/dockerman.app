<ChangelogEntry version="v2.1.0" date="Apr 30, 2025">
## Container Management Enhancements

This release significantly expands container management capabilities with multiple new features.

### ✨ Features:

- <Bold>Container Rename:</Bold> Implemented container rename functionality.
- <Bold>Enhanced Visibility:</Bold> Added option to display all containers regardless of status.
- <Bold>Container Control:</Bold> Implemented comprehensive container lifecycle management:
  - Container <Bold>stop</Bold> functionality
  - Container <Bold>start</Bold> functionality
  - Container <Bold>restart</Bold> functionality
  - Container <Bold>remove</Bold> functionality

<ChangelogImage src="/changelog/2.1.0.png" alt="Dockerman 2.1.0" />
