  ...
  const features = [
    {
      ...
      description:
        "Built with Tauri and Rust for lightning-fast powerful desktop experience.",
    },
    {
      name: "Real-time Monitoring",
      description:
        "Monitor container stats, logs, and resource usage in real-time.",
    },
    {
      name: "Container Management",
      description:
        "Easily manage containers with detailed inspection and terminal access.",
    },
  ]
